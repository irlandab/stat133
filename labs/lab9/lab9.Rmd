...
The purpose of this lab is two-fold: 1) getting started with writing tests for
your functions, and 2) getting started with functions to do basic manipulation 
of strings.
...
| `expect_type(x, y)`       | expects that `x` is of type `y`               |
